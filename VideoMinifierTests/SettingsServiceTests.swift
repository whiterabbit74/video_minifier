...
final class SettingsServiceTests: XCTestCase {
    ...
    @MainActor override func setUp() {
        ...
        mockUserDefaults = UserDefaults(suiteName: "test.VideoMinifier.SettingsServiceTests")!
        
        // Clear any existing data
        mockUserDefaults.removePersistentDomain(forName: "test.VideoMinifier.SettingsServiceTests")
